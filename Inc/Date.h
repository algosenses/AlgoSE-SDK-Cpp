#ifndef ALGOSE_DATE_H
#define ALGOSE_DATE_H
...
ALGOSE_API long operator-(const Date& d1, const Date& d2);
ALGOSE_API bool operator==(const Date& d1, const Date& d2);
ALGOSE_API bool operator!=(const Date& d1, const Date& d2);
ALGOSE_API bool operator<(const Date& d1, const Date& d2);
ALGOSE_API bool operator<=(const Date& d1, const Date& d2);
ALGOSE_API bool operator>(const Date& d1, const Date& d2);
